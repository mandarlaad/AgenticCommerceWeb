...
Made it work using OpenAI model, nova is blocked in EUS2 region (except the label in your UI is hardcoded as Bedrock Runtime have fixed that, but we can leave it as is). For some reason it currently works only for the treadmill query, so during demo we have to show as if we are showing two types of product searches.
